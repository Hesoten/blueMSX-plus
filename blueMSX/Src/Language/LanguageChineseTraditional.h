...
void langInitChineseTraditional(LanguageStrings* ls) 
{
    ...
    ls->infoGameReaderNoDll     = "使用 MSX Game Reader 需要 MSXGr.dll。\nASCII 公司的原版 DLL 無法在目前的 Windows 上運作，請安裝 MSXGr-WinUSB (Sebbeug 製作)，或使用 MSX Game Reader - Web Dumper (Kunihiko Ohnaka 製作)。";
    ls->infoGameReaderNoDevice  = "找不到用於卡匣插槽 %d 的 MSX Game Reader。請檢查是否已正確連接。";
    ls->dlgGameReaderGetDll     = "開啟 MSXGr-WinUSB 下載頁面";
    ls->dlgGameReaderWebDumper  = "開啟 Web Dumper";
    ...
    ls->infoToastMouseConnected    = "PC 滑鼠已連接到 MSX";
    ls->infoToastMouseDisconnected = "PC 滑鼠已從 MSX 中斷連接";
    ls->propControlsMouseSens      = "靈敏度:";
    ...
    ls->menuFileStopRecordVideo     = "停止錄製視訊";
    ls->shortcutRecordVideoStart    = "錄製視訊：開始";
    ls->shortcutRecordVideoStartAs  = "錄製視訊：另存為開始";
    ls->shortcutRecordVideoStop     = "錄製視訊：停止";
    ls->shortcutRecordVideoToggle   = "錄製視訊：切換";
    ls->shortcutAudioCaptureAs      = "錄製音訊：另存為開始";
    ls->shortcutVideoRecordAs       = "回放：另存為錄製";
    ls->shortcutScreenshotAs        = "螢幕擷取：另存為";

    ls->propCapture                 = "錄製";
    ls->propCaptureAudioGB          = " 音訊錄製 ";
    ls->propCaptureVideoGB          = " 視訊錄製 ";
    ls->propCaptureScreenshotGB     = " 螢幕擷取 ";
    ls->propCaptureReplayGB         = " 回放記錄 ";
    ls->propCaptureSaveDir          = "儲存目錄：";
    ls->propCaptureFormat           = "格式：";
    ls->propCaptureCodec            = "編解碼：";
    ls->propCaptureAutoName         = "自動命名檔案";
    ls->propCapturePromptName       = "提示輸入檔名";
    ls->propCaptureShowToast        = "錄製完成時顯示通知";
    ...
    ls->menuCasSaveMonitor       = "儲存時播放監聽聲音";
    ...
    ls->dlgSaveCaptureReplay    = "回放另存為";
    ls->dlgSaveCaptureScreenshot = "螢幕擷取另存為";
    ...
    ls->propEmuSpeedText        = "模擬器核心:";
    ls->propEmuVdpCmdSpeedText  = "VDP命令等待時間:";
    ls->propEmuFrontSwitchGB     = "Panasonic 開關 ";
    ls->propEmuFrontSwitch       = " 前端開關";
    ls->propEmuNoSpriteLimits   = " 停用精靈數量限制";  // New in 2.9
    ls->propEnableMsxKeyboardQuirk = " 模擬 MSX 鍵盤特殊行為";  // New in 2.9
    ls->propEmuBoostText        = "裝置存取時加速:";
    ls->propEmuFdcTiming        = " 軟碟";
    ls->propEmuCasBoost         = " 磁帶";
    ls->propEmuHddSdBoost       = " HDD/SD 卡";
    ls->propEmuReversePlay      = " 啟用倒放"; // New in 2.8.3
    ...
    ls->propMonScanlinesBright  = "亮度補償:";
    ls->propMonScanlinesBrightAuto = " 自動";
    ls->propMonScanlinesShape   = "預設:";
    ls->propMonScanlinesDepth   = "深度:";
    ls->propMonScanlinesSharpness = "銳度:";
    ls->enumScanShapeGentle     = "柔和";
    ls->enumScanShapeStandard   = "標準";
    ls->enumScanShapeSharp      = "銳利";
    ls->enumScanShapeTrinitron  = "特麗霓虹";
    ls->enumScanShapeCustom     = "自訂";
    ls->propMonHdrEnable        = "HDR";
    ls->propMonHdrPaperWhite    = "白色亮度:";
    ls->propMonHdrSystemMode    = "系統 HDR 模式:";
    ls->propMonHdrRestartHint   = "請重新啟動 blueMSX 以套用 HDR 模式變更。";
    ls->propMonHdrRecord        = " 以 HDR 錄製";
    ...
    ls->propD3DParametersGB         = "參數 ";                // New in 2.9
    ls->propD3DAspectRatioText      = "寬高比";               // New in 2.9
    ls->propD3DScalingFilterText     = "縮放濾鏡";
    ls->propD3DExtendBorderColorText    = " 擴展邊框顏色";   // New in 2.9

    ls->propD3DCroppingGB               = "裁剪 ";              // New in 2.9
    ls->propD3DCroppingTypeText         = "裁剪類型:";         // New in 2.9
    ...
    ls->enumD3DARAuto           = "自動";           // New in 2.9
    ls->enumD3DARStretch        = "拉伸";        // New in 2.9
    ls->enumD3DARPAL            = "PAL";            // New in 2.9
    ls->enumD3DARNTSC           = "NTSC";           // New in 2.9
    ls->enumD3DAR11             = "1:1";            // New in 2.9
    ls->enumD3DScaleNearest          = "最近鄰";
    ls->enumD3DScaleBilinear         = "雙線性";
    ls->enumD3DScaleSharp            = "銳利雙線性";
    ls->enumD3DScalePrescaled     = "雙線性(2x預縮放)";

    ls->enumD3DCropNone         = "無";           // New in 2.9
    ...
    ls->enumD3DCropCustom       = "自訂";         // New in 2.9
    ...
    ls->keyconfigResetTab       = "將此頁的按鍵配置重設為預設";
    ...
    ls->shortcutToggleMouseLock = "連接/中斷 PC 滑鼠與 MSX";
    ls->shortcutEmuSpeedMax     = "最高模擬速度";
    ls->shortcutEmuPlayReverse  = "回退模擬";                     // New in 2.8.3
    ...
    ls->shortcutShowEffectsProp = "顯示特效屬性";     // New in 2.9
    ...
    ls->shortcutToggleFdcTiming = "切換軟碟存取加速";
    ls->shortcutToggleHddSdBoost = "切換硬碟/SD存取加速";
    ls->shortcutToggleNoSpriteLimits = "切換精靈數量限制";                 // New in 2.9
    ls->shortcutEnableMsxKeyboardQuirk = "模擬 MSX 鍵盤特殊行為";              // New in 2.9
    ls->shortcutToggleCpuTrace  = "啟用/停用 CPU 追蹤";
    ls->shortcutVideoLoad       = "回放：從檔案載入";             
    ls->shortcutVideoPlay       = "回放：播放最後錄製";   
    ls->shortcutVideoRecord     = "回放：錄製";              
    ls->shortcutVideoStop       = "回放：停止";                
    ls->shortcutVideoRender     = "回放：匯出為視訊";   

...
char* langErrorStartEmuNoMachine();
char* langErrorStartEmuMachinesDirMissing();
char* langErrorStartEmuMachineNotFound();
...
char* langInfoTitle();
char* langInfoGameReaderNoDll();
char* langInfoGameReaderNoDevice();
char* langDlgGameReaderGetDll();
char* langDlgGameReaderWebDumper();
...
char* langInfoToastMouseConnected();
char* langInfoToastMouseDisconnected();
char* langPropControlsMouseSens();
char* langDlgRecorderPickTitle();
char* langDlgRecorderPickSourceCap();
char* langDlgRecorderPickOutputMp4();
char* langMenuFileRecordVideo();
char* langMenuFileStopRecordVideo();
char* langShortcutRecordVideoStart();
char* langShortcutRecordVideoStartAs();
char* langShortcutRecordVideoStop();
char* langShortcutRecordVideoToggle();
char* langShortcutAudioCaptureAs();
char* langShortcutVideoRecordAs();
char* langShortcutScreenshotAs();
char* langPropCapture();
char* langPropCaptureAudioGB();
char* langPropCaptureVideoGB();
char* langPropCaptureScreenshotGB();
char* langPropCaptureReplayGB();
char* langPropCaptureSaveDir();
char* langPropCaptureFormat();
char* langPropCaptureCodec();
char* langPropCaptureAutoName();
char* langPropCapturePromptName();
char* langPropCaptureShowToast();
...
char* langDlgSaveCaptureAudio();
char* langDlgSaveCaptureVideo();
char* langDlgSaveCaptureReplay();
char* langDlgSaveCaptureScreenshot();
...
char* langPropEmuBoostText();
char* langPropEmuFdcTiming();
char* langPropEmuCasBoost();
char* langPropEmuHddSdBoost();
...
char* langPropSndOpllAnalogText();
char* langPropSndOpllAnalogLpfText();
char* langEnumOpllFilterOff();
char* langEnumOpllFilterBright();
char* langEnumOpllFilterClear();
char* langEnumOpllFilterStandard();
char* langEnumOpllFilterSoft();
char* langEnumOpllFilterMellow();
char* langEnumOpllFilterCustom();
...
char* langPropMonScanlinesBright();
char* langPropMonScanlinesBrightAuto();
char* langPropMonScanlinesShape();
char* langPropMonScanlinesDepth();
char* langPropMonScanlinesSharpness();
char* langEnumScanShapeGentle();
char* langEnumScanShapeStandard();
char* langEnumScanShapeSharp();
char* langEnumScanShapeTrinitron();
char* langEnumScanShapeCustom();
char* langPropMonHdrEnable();
char* langPropMonHdrPaperWhite();
char* langPropMonHdrSystemMode();
char* langPropMonHdrRestartHint();
char* langPropMonHdrRecord();
...
char* langPropSoundChipsActive();
char* langPropSoundChipsHint();
char* langPropSoundChipsYm2413GB();
char* langPropSoundChipsY8950GB();
...
char* langShortcutYm2413BackendCycle();
char* langShortcutY8950BackendCycle();
...
char* langShortcutToggleHddSdBoost();

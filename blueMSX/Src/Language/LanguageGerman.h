...
void langInitGerman(LanguageStrings* ls) 
{
    ...
    ls->errorStartEmuNoMachine           = "Es ist keine MSX-Maschine für die Emulation eingestellt. Wählen Sie eine unter Options -> Emulation -> MSX-Maschine.";
    ls->errorStartEmuMachinesDirMissing  = "Der Ordner Machines wurde nicht gefunden.";
    ls->errorStartEmuMachineNotFound     = "Die ausgewählte Maschinenkonfiguration '%s' wurde nicht gefunden.";
    ls->errorStartEmuConfigInvalid       = "Die config.ini der Maschinenkonfiguration '%s' konnte nicht gelesen werden. Die Datei ist möglicherweise beschädigt oder stammt aus einer inkompatiblen Version.";
    ls->errorMissingFiles        = "Folgende Dateien konnten nicht geladen werden:";
    ls->errorPortableReadonly    = "Austauschbarer Datenträger ist nur lesbar"; // "Portable device is readonly";        
    ls->errorMidiOpenFailed      = "MIDI-Gerät '%s' konnte nicht geöffnet werden. Wird evtl. von anderer Anwendung genutzt.";
    ls->infoTitle                = "blueMSX+ Info";
    ls->infoGameReaderNoDll      = "MSXGr.dll wird für den MSX Game Reader benötigt.\nDie Original-DLL von ASCII funktioniert unter aktuellem Windows nicht mehr, daher MSXGr-WinUSB (von Sebbeug) installieren oder den MSX Game Reader - Web Dumper (von Kunihiko Ohnaka) verwenden.";
    ls->infoGameReaderNoDevice   = "Kein MSX Game Reader für Modulsteckplatz %d gefunden. Bitte den Anschluss prüfen.";
    ls->dlgGameReaderGetDll      = "MSXGr-WinUSB-Downloadseite öffnen";
    ls->dlgGameReaderWebDumper   = "Web Dumper öffnen";
    ...
    ls->errorRecorderReplayMissing = "Replay-Datei nicht gefunden:\n  %s\n\nNehmen Sie zuerst ein Replay auf, oder wählen Sie über Laden eine vorhandene .cap-Datei.";
    ls->errorRecorderRequiresDX12   = "Auf Direct3D 12 als Videotreiber wechseln und Aufnahme starten?";
    ls->errorRecorderRequiresDX12Title = "blueMSX+ - Videotreiberwechsel";
    ...
    ls->menuPropsEffects        = "Effekte";               // New in 2.9
    ...
    ls->menuFileHarddisk         = "Festplatte / SD-Karte";                 // "Hard Disk";                          
    ...
    ls->propEffects              = "Effekte";             // New in 2.9
    ...
    ls->propEmuSpeedText         = "Emulator-Kern:";
    ls->propEmuVdpCmdSpeedText  = "VDP-Befehl-Wartezeit:";
    ...
    ls->propMonScanlinesBright   = "Hellig.-komp.:";
    ls->propMonScanlinesBrightAuto  = " Auto";
    ls->propMonScanlinesShape    = "Voreinst.:";
    ls->propMonScanlinesDepth    = "Tiefe:";
    ls->propMonScanlinesSharpness  = "Schärfe:";
    ls->enumScanShapeGentle      = "Sanft";
    ls->enumScanShapeStandard    = "Standard";
    ls->enumScanShapeSharp       = "Scharf";
    ls->enumScanShapeTrinitron   = "Trinitron";
    ls->enumScanShapeCustom      = "Benutzerd.";
    ...
    ls->propD3DParametersGB         = "Parameter ";                // New in 2.9
    ls->propD3DAspectRatioText      = "Seitenverhältnis";               // New in 2.9
    ls->propD3DScalingFilterText     = "Skalierungsfilter";
    ls->propD3DExtendBorderColorText    = " Randfarbe erweitern";   // New in 2.9

    ls->propD3DCroppingGB               = "Zuschnitt ";              // New in 2.9
    ls->propD3DCroppingTypeText         = "Zuschnitttyp:";         // New in 2.9
    ls->propD3DCroppingLeftText         = "Links:";                  // New in 2.9
    ls->propD3DCroppingRightText        = "Rechts:";                 // New in 2.9
    ls->propD3DCroppingTopText          = "Oben:";                   // New in 2.9
    ls->propD3DCroppingBottomText       = "Unten:";                // New in 2.9
    ...
    ls->enumD3DARStretch        = "Strecken";        // New in 2.9
    ls->enumD3DARPAL            = "PAL";            // New in 2.9
    ls->enumD3DARNTSC           = "NTSC";           // New in 2.9
    ls->enumD3DAR11             = "1:1";            // New in 2.9
    ls->enumD3DScaleNearest          = "Nächster";
    ls->enumD3DScaleBilinear         = "Bilinear";
    ls->enumD3DScaleSharp            = "Scharf bilinear";
    ls->enumD3DScalePrescaled     = "Bilinear (2x prescale)";

    ls->enumD3DCropNone         = "Keine";           // New in 2.9
    ...
    ls->enumD3DCropCustom       = "Benutzerdefiniert";         // New in 2.9
    ...
    ls->enumDiskFormatUnformatted= "Nicht formatiert";
    ...
    ls->shortcutShowEffectsProp = "Effekt-Eigenschaften anzeigen";     // New in 2.9
    ...
    ls->shortcutToggleFdcTiming    = "FDD-Beschleunigung umschalten";
    ls->shortcutToggleHddSdBoost = "HDD/SD-Beschleunigung umschalten";
    ls->shortcutToggleNoSpriteLimits = "Sprite-Beschränkung umschalten";                 // New in 2.9
    ls->shortcutEnableMsxKeyboardQuirk = "MSX-Tastatureigenart emulieren";              // New in 2.9

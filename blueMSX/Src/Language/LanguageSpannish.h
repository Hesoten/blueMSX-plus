...
void langInitSpanish(LanguageStrings* ls)
{
    ...
    ls->infoGameReaderNoDll     = "Se necesita MSXGr.dll para usar MSX Game Reader.\nEl DLL original de ASCII no funciona en Windows actual, así que instale MSXGr-WinUSB (por Sebbeug) o use MSX Game Reader - Web Dumper (por Kunihiko Ohnaka).";
    ls->infoGameReaderNoDevice  = "No se encontró ningún MSX Game Reader para la ranura de cartucho %d. Compruebe que esté bien conectado.";
    ls->dlgGameReaderGetDll     = "Abrir la descarga de MSXGr-WinUSB";
    ls->dlgGameReaderWebDumper  = "Abrir el Web Dumper";
    ls->infoColorDepth          = "blueMSX+ funciona mejor con profundidad de color de 16 o 32 bits.";
    ls->errorKeyboardThemeMissing = "No se pudo encontrar el tema del editor de teclado.";
    ls->errorMixerThemeMissing    = "No se pudo encontrar el tema del mezclador.";
    ...
    ls->errorRecorderRequiresDX12   = "¿Cambiar el controlador de vídeo a Direct3D 12 e iniciar la grabación?";
    ls->errorRecorderRequiresDX12Title = "blueMSX+ - Cambio de controlador de vídeo";
    ls->infoRecorderComplete    = "Archivo de vídeo guardado:\n  %s";
    ls->infoToastSaved          = "Guardado: %s";
    ls->infoToastAlreadyRecording   = "Ya en grabación";
    ls->infoToastMouseConnected    = "Ratón PC conectado al MSX";
    ls->infoToastMouseDisconnected = "Ratón PC desconectado del MSX";
    ls->propControlsMouseSens      = "Sensibilidad:";
    ls->dlgRecorderPickTitle        = "blueMSX+ - Renderizar replay a vídeo";
    ls->dlgRecorderPickSourceCap    = "Archivo de replay a renderizar (.cap):";
    ls->dlgRecorderPickOutputMp4    = "Archivo de vídeo de salida (.mp4):";
    ls->menuFileRecordVideo         = "Grabar vídeo";
    ls->menuFileStopRecordVideo     = "Detener grabación de vídeo";
    ls->shortcutRecordVideoStart    = "Grabación de vídeo: Iniciar";
    ls->shortcutRecordVideoStartAs  = "Grabación de vídeo: Iniciar como";
    ls->shortcutRecordVideoStop     = "Grabación de vídeo: Detener";
    ls->shortcutRecordVideoToggle   = "Grabación de vídeo: Alternar";
    ls->shortcutAudioCaptureAs      = "Grabación de audio: Iniciar como";
    ls->shortcutVideoRecordAs       = "Replay: Grabar como";
    ls->shortcutScreenshotAs        = "Captura: Guardar como";

    ls->propCapture                 = "Captura";
    ls->propCaptureAudioGB          = " Grabación de audio ";
    ls->propCaptureVideoGB          = " Grabación de vídeo ";
    ls->propCaptureScreenshotGB     = " Captura ";
    ls->propCaptureReplayGB         = " Grabación de replay ";
    ...
    ls->menuPropsEffects        = "Efectos";               // New in 2.9
    ...
    ls->dlgSaveCaptureAudio     = "Guardar grabación de audio como";
    ls->dlgSaveCaptureVideo     = "Guardar grabación de vídeo como";
    ls->dlgSaveCaptureReplay    = "Guardar replay como";
    ls->dlgSaveCaptureScreenshot = "Guardar captura como";
    ...
    ls->propEffects             = "Efectos";             // New in 2.9
    ...
    ls->propMonScanlinesBright  = "Comp. brillo:";
    ls->propMonScanlinesBrightAuto = " Auto";
    ls->propMonScanlinesShape   = "Predef.:";
    ls->propMonScanlinesDepth   = "Profundidad:";
    ls->propMonScanlinesSharpness = "Nitidez:";
    ls->enumScanShapeGentle     = "Suave";
    ls->enumScanShapeStandard   = "Estándar";
    ls->enumScanShapeSharp      = "Nítido";
    ...
    ls->enumOpllFilterSoft      = "Suave (LPF 3.5 kHz)";
    ls->enumOpllFilterMellow    = "Aterciopelado (LPF 2.3 kHz)";
    ...
    ls->propD3DParametersGB         = "Parámetros ";                // New in 2.9
    ls->propD3DAspectRatioText      = "Relación de aspecto";               // New in 2.9
    ls->propD3DScalingFilterText     = "Filtro de escala";
    ls->propD3DExtendBorderColorText    = " Extender color del borde";   // New in 2.9

    ls->propD3DCroppingGB               = "Recorte ";              // New in 2.9
    ls->propD3DCroppingTypeText         = "Tipo de recorte:";         // New in 2.9
    ls->propD3DCroppingLeftText         = "Izquierda:";                  // New in 2.9
    ls->propD3DCroppingRightText        = "Derecha:";                 // New in 2.9
    ls->propD3DCroppingTopText          = "Arriba:";                   // New in 2.9
    ls->propD3DCroppingBottomText       = "Abajo:";                // New in 2.9
    ...
    ls->enumD3DScaleNearest          = "Más cercano";
    ls->enumD3DScaleBilinear         = "Bilineal";
    ls->enumD3DScaleSharp            = "Bilineal nítido";
    ls->enumD3DScalePrescaled     = "Bilineal (2x prescale)";

    ls->enumD3DCropNone         = "Ninguno";           // New in 2.9
    ...
    ls->enumDiskSize             = "Tamaño del disco";
    ls->enumDiskFormat           = "Formato:";
    ls->enumDiskFormatUnformatted= "Sin formato";
    ...
    ls->shortcutToggleMouseLock = "Conectar/desconectar el ratón PC al MSX";
    ls->shortcutEmuSpeedMax     = "Velocidad máxima de la emulación";
    ls->shortcutEmuPlayReverse  = "Rebobinar emulación";                     // New in 2.8.3
    ...
    ls->shortcutShowEffectsProp = "Mostrar propiedades de efectos";     // New in 2.9
    ...
    ls->shortcutToggleFdcTiming = "Alternar aceleración FDD"; 
    ls->shortcutToggleHddSdBoost = "Alternar aceleración HDD/SD";
    ls->shortcutToggleNoSpriteLimits = "Alternar limitación de sprites";                 // New in 2.9
    ls->shortcutEnableMsxKeyboardQuirk = "Emular peculiaridad del teclado MSX";              // New in 2.9
    ls->shortcutToggleCpuTrace  = "Activar/Desactivar Rastro de la CPU"; 
    ls->shortcutVideoLoad       = "Replay: Cargar desde archivo";             
    ls->shortcutVideoPlay       = "Replay: Reproducir última";   
    ls->shortcutVideoRecord     = "Replay: Grabar";              
    ls->shortcutVideoStop       = "Replay: Parar";                
    ls->shortcutVideoRender     = "Replay: Exportar a vídeo";   

...
void langInitPortuguese(LanguageStrings* ls) 
{
    ...
    ls->errorRecorderRequiresDX12   = "Mudar o driver de vídeo para Direct3D 12 e iniciar a gravação?";
    ls->errorRecorderRequiresDX12Title = "blueMSX+ - Alteração do driver de vídeo";
    ls->infoRecorderComplete    = "Arquivo de vídeo salvo:\n  %s";
    ls->infoToastSaved          = "Salvo: %s";
    ls->infoToastAlreadyRecording   = "Já em gravação";
    ls->infoToastMouseConnected    = "Mouse PC conectado ao MSX";
    ls->infoToastMouseDisconnected = "Mouse PC desconectado do MSX";
    ls->propControlsMouseSens      = "Sensibilidade:";
    ...
    ls->propEmuSpeedText        = "Núcleo emulador:";
    ...
    ls->enumOpllFilterOff       = "Desativado";
    ls->enumOpllFilterBright    = "Brilhante (LPF 12 kHz)";
    ls->enumOpllFilterClear     = "Claro (LPF 8 kHz)";
    ls->enumOpllFilterStandard  = "Padrão (LPF 5 kHz)";
    ls->enumOpllFilterSoft      = "Suave (LPF 3.5 kHz)";
    ls->enumOpllFilterMellow    = "Aveludado (LPF 2.3 kHz)";
    ls->enumOpllFilterCustom    = "Personalizado";
    ...
    ls->enumD3DScaleNearest          = "Mais próximo";
    ls->enumD3DScaleBilinear         = "Bilinear";
    ls->enumD3DScaleSharp            = "Bilinear nítido";
    ...
    ls->keyconfigResetTab       = "Repor as teclas deste separador";
    ...
    ls->shortcutToggleMouseLock = "Conectar/desconectar mouse PC ao MSX";

...
/* Suspend-yield helper invoked from archWaitForAckOrSuspend: parks the
** emu thread until emuState returns to EMU_RUNNING. Returns non-zero
** when the wait was broken by an exit request. */

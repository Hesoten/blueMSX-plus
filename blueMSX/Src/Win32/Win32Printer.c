...
**
** Copyright (C) 2003-2006 Rudolf Lechleitner, Daniel Vik, Tomas Karlsson
**
...
static BYTE SVIFontRaw[256*8] = {
    ...
    0x48, 0xFC, 0xFC, 0xFC, 0xFC, 0x78, 0x30, 0x30,
    0x04, 0x08, 0x18, 0x10, 0x20, 0x60, 0x40, 0x80,
    0x84, 0x48, 0x78, 0x30, 0x30, 0x78, 0x48, 0x84,
    0x80, 0x40, 0x60, 0x20, 0x10, 0x18, 0x08, 0x04,
    0x30, 0x78, 0xCC, 0x84, 0x84, 0xCC, 0x78, 0x30,
    0x1C, 0x1C, 0x1C, 0x1C, 0xE0, 0xE0, 0xE0, 0xE0,
    0x30, 0x78, 0xFC, 0xFC, 0xFC, 0xFC, 0x78, 0x30,
    ...
    0x30, 0x30, 0xFC, 0xFC, 0xCC, 0x30, 0x30, 0x78,
    0x30, 0x30, 0x78, 0xFC, 0xFC, 0x78, 0x30, 0x30,
    0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04, 0x04,
    0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC, 0xFC,
    0xFC, 0xF8, 0xF0, 0xE0, 0xE0, 0xC0, 0x80, 0x80,
    0x00, 0x00, 0x00, 0x00, 0xA8, 0x54, 0xA8, 0x54,
    0x04, 0x04, 0x0C, 0x1C, 0x1C, 0x3C, 0x7C, 0xFC,
    0xA0, 0x40, 0xA0, 0x40, 0xA0, 0x40, 0xA0, 0x40,
    0x00, 0x00, 0x00, 0x00, 0x04, 0x08, 0x10, 0x10,
    0x30, 0x78, 0xFC, 0xFC, 0xFC, 0x30, 0x30, 0x78,
    0xFC, 0x7C, 0x3C, 0x1C, 0x1C, 0x0C, 0x04, 0x04,
    ...
    0x20, 0x20, 0x20, 0xA8, 0x70, 0x20, 0x00, 0x00,
    0x38, 0x10, 0x10, 0x10, 0x90, 0x90, 0x60, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x60, 0x60, 0x00,
    0x70, 0x88, 0x80, 0x70, 0x08, 0x88, 0x70, 0x00,
    0x00, 0x00, 0x90, 0x90, 0x90, 0x90, 0x68, 0x00,
...
void MsxPrnSetFont(BYTE* msxBits)
{
    ...
    if ((printerType != P_LPT_MSXPRN) && (printerType != P_LPT_SVIPRN)) {
        return;
    }
...
void EnsurePrintPage(void)
{
    ...
    if (!fPrintDataOnPage) {
        if (hdcPrinter) {
            ...
            GetCurrentDirectoryU(MAX_PATH - 1, originalDir);
            if (*printDir) {
                SetCurrentDirectoryU(printDir);
            }
            StartDoc( hdcPrinter, &di );
            StartPage( hdcPrinter );
            
            GetCurrentDirectoryU(MAX_PATH - 1, printDir);
            SetCurrentDirectoryU(originalDir);
        }
...
static void EpsonFx80ProcessCharacter(BYTE bChar)
{
    ...
    case 9:  // Horizontal TAB
        // ToDo: fix for other font-sizes ***
        stPrtRam.uiHpos = ((UINT)stPrtRam.uiHpos + 64 - stPrtRam.uiLeftBorder) & ~63;
        stPrtRam.uiHpos += stPrtRam.uiLeftBorder;
...
static int printerCreate(void)
{
    ...
    else if (printerType == P_LPT_SVIPRN) {
        MsxPrnSetFont(SVIFontRaw);
    }
